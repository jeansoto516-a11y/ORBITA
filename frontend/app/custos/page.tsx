...
export default function CustosPage() {
    ...
    return (
        ...
        <div className="mb-8 flex items-center justify-between">
            ...
            <DialogTrigger render={<Button>Novo custo</Button>} />
            <DialogContent>
                <DialogHeader>
        ...
        {resumo.length > 0 && (
            ...
            <div className="grid gap-3 sm:grid-cols-2">
                {resumo.map((item) => (
                <div key={item.contrato_id} className="rounded-lg border p-4">
                    <p className="text-sm font-medium">{item.numero_contrato} — {item.titulo}</p>
        ...
        <div className="rounded-lg border">
            ...
            <TableBody>
                ...
                <TableRow key={custo.id}>
                    ...
                    <TableCell>{custo.contrato?.numero_contrato ?? "—"}</TableCell>
                    <TableCell>{TIPO_LABEL[custo.tipo]}</TableCell>
                    <TableCell>{formatarMoeda(custo.valor)}</TableCell>
