        ...
        <div className="mb-10 flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Acompanhamento das ordens de serviço em execução — {ordens.length} no total.
            </p>
          </div>

          <Dialog open={modalAberto} onOpenChange={setModalAberto}>
            <DialogTrigger render={<Button><Plus className="h-4 w-4" />Nova OS</Button>} />
            <DialogContent>
              <DialogHeader>
            ...
            <TableBody>
              ...
              {ordens.map((os) => (
                ...
                >
                  ...
                  <TableCell className="font-mono text-sm">{os.contrato?.numero_contrato ?? "—"}</TableCell>
